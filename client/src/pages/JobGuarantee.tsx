...
import type {
  ...
  TwoColumnSection as TwoColumnSectionType,
...
} from "@/components/NumberedSteps";
import StatsSection, { type StatsSectionData } from "@/components/StatsSection";
import { FeaturesGridDetailed } from "@/components/features-grid/FeaturesGridDetailed";
...
const heroData = {
  ...
  subtitle:
    "Your success is our mission — Get hired within 9 months of graduation, or we will refund your tuition. Conditions apply.",
  cta_buttons: [
    {
      text: "Apply now",
      url: "#apply",
...
const statsData: StatsSectionData = {
  ...
  description:
    "Yes, and we've got the numbers to back it up. These stats reflect our full graduate community and demonstrate the proven impact of our programs across the board. We don't just teach you how to code, we help you build a career you're proud of.",
};
...
const refundData: NumberedStepsData = {
  ...
  steps: [
    {
      text: "You were not hired into a qualifying role within 9 months of graduation.",
      icon: "BriefcaseOff",
    },
    {
      text: "Our team verifies that you met all Job Guarantee requirements.",
      icon: "ClipboardCheck",
    },
  ...
  items: [
    {
      ...
      answer:
        "Our Job Guarantee ensures that if you meet all program requirements and still don't get a qualifying tech job within 9 months of graduation, you are eligible for a full refund of your tuition. It's our way of backing the real-world outcomes our bootcamp delivers. Conditions apply.",
    },
    {
      question:
        "Does the Job Guarantee refund the full tuition if I don't get hired?",
      answer:
    ...
    {
      question:
        "How long do I have to look for a job before the refund is issued?",
      answer:
    ...
    },
    {
      ...
      answer:
        "You must: Complete 100% of coursework and projects, attend sessions consistently, follow the steps our career services team advises, actively apply to jobs and document your search, and hold valid U.S. work authorization.",
    },
    {
    ...
    {
      question:
        "Can I finance the additional $2,000 Job Guarantee fee with my tuition?",
      answer:
    ...
    {
      question:
        "What's the average time it takes for 4Geeks grads to get hired?",
      answer:
    ...
    {
      question:
        "If I'm offered a contract job, does it count toward the guarantee?",
      answer:
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <FeaturesGridDetailed data={programsData} />
