      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="hidden md:block relative">
          ...
          <div className="relative grid grid-cols-[1fr_minmax(400px,2fr)_1fr] grid-rows-[auto_1fr] gap-4">
            ...
            {steps[1] && (
              <div
                className={`col-start-2 row-start-1 flex flex-col items-center justify-center -mb-8 transition-opacity duration-300 ${getStepOpacity(1)}`}
            ...
            >
              <div
                className={`relative bg-card border-2 border-primary/30 rounded-[3rem] lg:rounded-[6rem] p-6 lg:p-10 shadow-lg w-full max-w-[420px] min-h-[200px] lg:min-h-[280px] flex flex-col
