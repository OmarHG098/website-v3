    ...
    <section className="relative container mx-auto px-4 py-16 md:py-24 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr_1fr] gap-8 items-center max-w-7xl mx-auto">
        ...
        <div className="relative h-[300px] lg:h-[500px] hidden lg:block">
          ...
          <div 
            className="absolute top-32 right-0 w-56 transform rotate-3 transition-transform hover:rotate-0 hover:scale-105 z-10"
            style={{ boxShadow: '0 10px 30px rgba(0,0,0,0.15)' }}
          >
            <img 
              src={happyDevImage} 
        ...
        <div className="relative h-[300px] lg:h-[500px] hidden lg:block">
          ...
          <div 
            className="absolute top-32 left-0 w-56 transform -rotate-3 transition-transform hover:rotate-0 hover:scale-105 z-20"
            style={{ boxShadow: '0 10px 30px rgba(0,0,0,0.15)' }}
          >
            <img 
              src={teamImage} 
