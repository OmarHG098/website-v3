        ...
        <div className="hidden lg:block space-y-8">
          <div className="grid grid-cols-12 gap-8 items-start">
            <div className="col-span-7">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl">{data.description}</p>
            </div>
            <div className="col-span-5 flex items-start gap-4 bg-primary/5 p-4 rounded-card h-44">
              {renderMedia(
