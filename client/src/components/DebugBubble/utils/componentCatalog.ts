...
export const componentsList: ComponentItem[] = [
  ...
  { type: "graduates_stats", label: "Graduates Stats (Full Bleed)", icon: IconUsersGroup, description: "Full-bleed featured images with compact stats", variant: "full_bleed_duo" },
];
