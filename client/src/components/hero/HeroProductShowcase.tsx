    ...
    >
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-5 gap-12 md:gap-16 items-start">
          ...
          <div className="md:col-span-2 w-full md:w-auto flex flex-col items-center md:items-start justify-center">
            ...
            {marquee && marquee.items && marquee.items.length > 0 && (
              <div className="w-full mt-8 md:mt-12" data-testid="hero-embedded-marquee">
                <Marquee
