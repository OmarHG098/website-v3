      ...
      <div className="relative max-w-6xl mx-auto px-4 py-14">
        ...
        <div className="md:hidden space-y-6">
          <div className="flex gap-4 items-stretch">
            ...
            {images.length > 0 && (
              <div className="flex items-stretch gap-2 bg-primary/5 p-2 rounded-card min-h-16" data-testid="img-features-quad-mobile">
        ...
        <div className="hidden md:block lg:hidden space-y-8">
          <div className="flex gap-6 items-stretch">
            ...
            {images.length > 0 && (
              <div className="flex items-stretch gap-3 bg-primary/5 w-[300px] p-3 rounded-card min-h-24" data-testid="img-features-quad-tablet">
                {images.slice(0, 4).map((image, index) => (
                  <div key={index} className="flex-1">
                    <UniversalImage
                      id={image.image_id}
