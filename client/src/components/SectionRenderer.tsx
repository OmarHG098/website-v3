...
export function renderSection(section: Section, index: number): React.ReactNode {
  ...
  switch (sectionType) {
    ...
    case "awards_marquee": {
      const marqueeSection = section as unknown as { items?: unknown[]; subtitle?: string; speed?: number; gradient?: boolean; gradientWidth?: number };
      ...
      return (
        <AwardsMarquee 
          key={index} 
          items={validItems}
          subtitle={marqueeSection.subtitle}
