  ...
  return (
    <Card 
      className={cn(
        ...
        "bg-primary/5 md:bg-transparent border-2 md:border-0",
        isSelected
          ? "scale-[1.04] md:scale-[1.08] border-primary md:bg-primary/5"
          : "scale-100 border-transparent md:bg-[#f0f0f04d] md:dark:bg-[#ffffff0d]"
      )}
