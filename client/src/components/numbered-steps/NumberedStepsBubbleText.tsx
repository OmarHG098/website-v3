            ...
            {steps[1] && (
              ...
              >
                ...
                >
                  ...
                  <div className="absolute -bottom-12 -left-16 w-48 h-24 bg-gradient-to-l from-background via-background/70 to-transparent pointer-events-none" />
                  {/* Gradient fade for right connector line - horizontal fade to right */}
                  <div className="absolute -bottom-12 -right-16 w-48 h-24 bg-gradient-to-r from-background via-background/70 to-transparent pointer-events-none" />
                  {steps[1].title && (
