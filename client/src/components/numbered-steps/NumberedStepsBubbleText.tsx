      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="hidden md:block relative">
          ...
          <div className="relative grid grid-cols-[1fr_minmax(450px,2fr)_1fr] grid-rows-[auto_1fr] gap-4">
            ...
            {steps[0] && (
              <div
                className={`col-start-1 row-start-2 flex items-center justify-end h-full transition-opacity duration-300 ${getStepOpacity(0)}`}
            ...
            {steps[2] && (
              <div
                className={`col-start-3 row-start-2 flex items-center justify-start h-full transition-opacity duration-300 ${getStepOpacity(2)}`}
