          ...
          <div className="relative grid grid-cols-[1fr_minmax(450px,2fr)_1fr] grid-rows-[auto_1fr] gap-4">
            ...
            {steps[1] && (
              ...
              >
                ...
                >
                  {/* Gradient fade for left connector line - horizontal fade to left, centered vertically */}
                  <div className="absolute top-1/2 -translate-y-1/2 -left-16 w-48 h-24 bg-gradient-to-l from-background via-background/70 to-transparent pointer-events-none" />
                  {/* Gradient fade for right connector line - horizontal fade to right, centered vertically */}
                  <div className="absolute top-1/2 -translate-y-1/2 -right-16 w-48 h-24 bg-gradient-to-r from-background via-background/70 to-transparent pointer-events-none" />
                  {steps[1].title && (
